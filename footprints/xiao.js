...
module.exports = {
  ...
  body: p => {
    ...
    return `
      ...
      ${via(19, -15.1, 6.35, net('P5'))}
      ${via(18, -14.8, 3.81, net('P4'))}
      ${via(17, -14.5, 1.27, net('P3'))}
      ${via(16, -14.2, -1.27, net('P2'))}
      ${via(21, -13.9, -2.54, net('P1'))}

      ${via(19, -15.1, 8.89, net('P5'))}
      ${via(18, -14.8, 10.16, net('P4'))}
      ${via(17, -14.5, 11.43, net('P3'))}
      ${via(16, -14.2, 12.7, net('P2'))}
      ${via(21, -13.9, 13.97, net('P1'))}
      )
      `
  }
}
